...
const PersonalityTag = ({ personality, nickname }: PersonalityTagProps) => {
    ...
    const onPressPersonalityTag = () => {
        navigation.navigate("PersonalityResultScreen", {isSurveyDone : false, nickname:nickname || "temp_nickname", userType : "temp_userType", score1 : 1, score2 : 1, score3 : 1, score4 : 1});
    };
